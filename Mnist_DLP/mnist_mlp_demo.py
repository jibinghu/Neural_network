...
class MNIST_MLP(object):
    ...
    def build_model(self, batch_size=10000, input_size=784, 
                    hidden1=32, hidden2=16, out_classes=10): # 建立网络结构
        ...
        input_shapem2[0]=batch_size		# p
        input_shapem2[1]=1
        input_shapem2[2]=1
        input_shapem2[3]= hidden1		# m

        weight_shapem2=pycnnl.IntVector(4)  
        weight_shapem2[0]=batch_size	# p
        weight_shapem2[1]=1
        weight_shapem2[2]= hidden1		# m
        weight_shapem2[3]= hidden2		# n

        output_shapem2=pycnnl.IntVector(4)  
        output_shapem2[0]=batch_size	# p
        output_shapem2[1]=1
        output_shapem2[2]=1
        output_shapem2[3]= hidden2		# n
        ...
        input_shapem3[0]=batch_size		# p
        input_shapem3[1]=1
        input_shapem3[2]=1
        input_shapem3[3]= hidden2		# m
        weight_shapem3=pycnnl.IntVector(4)  
        weight_shapem3[0]=batch_size	# p
        weight_shapem3[1]=1
        weight_shapem3[2]= hidden2		# m
        weight_shapem3[3]= out_classes	# n

        output_shapem3=pycnnl.IntVector(4)  
        output_shapem3[0]=batch_size	# p
        output_shapem3[1]=1
        output_shapem3[2]=1
        output_shapem3[3]= out_classes	# n
        self.net.createMlpLayer('fc3', input_shapem3, weight_shapem3, output_shapem3)

        input_shapesm = pycnnl.IntVector(3)
        input_shapesm[0] = batch_size
        input_shapesm[1] = 1
        input_shapesm[2] = out_classes

        self.net.createSoftmaxLayer('softmax', input_shapesm, axis = 1)
        ## End
